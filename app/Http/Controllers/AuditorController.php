...
{
    public function auditorStore(Request $request)
    {
        ...
        try {
        $existingData = MasterData::where('key1', $request->auditor_name)->where('doc_type', 'IS_AUDITOR')->first();
        ...
        return response()->json([
            ...
            $model->key1 = $request->auditor_name;
            $model->key2 = 1;
            $model->doc_type = 'IS_AUDITOR';
            $model->save();
        }
    ...
    public function auditorList(Request $request)
    {
    ...
    public function auditorCategory(){

    $model = MasterData::where('doc_type','AUDITOR_TYPE')
                        ->orderBy('value1','ASC')
                        ->get();
    ...
    public function auditorUserList(){
